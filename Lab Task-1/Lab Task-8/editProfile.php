...
<legend>EDIT PROFILE</legend>                 
  ...
  <input type="text" id="semail" name="semail" placeholder="ex : abc@something.com" onkeyup="checkEmail()" onblur="checkEmail()">
  ...
  <input type="text" id="sphone" name="sphone" placeholder="ex : 017xxxxxxxxx" pattern="[0-9]{3}[0-9]{8}" onkeyup="checkPhoneNumber()" onblur="checkPhoneNumber()">
